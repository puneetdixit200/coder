...
Write out the current server config as YAML to stdout.`,
		...
		// AI Bridge Options
		{
			...
			Value:       &c.AI.GatewayConfig.Enabled,
			Default:     "false",
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyOpenAI.BaseURL,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyOpenAI.Key,
			Default:     "",
			Group:       &deploymentGroupAIGateway,
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyAnthropic.BaseURL,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyAnthropic.Key,
			Default:     "",
			Group:       &deploymentGroupAIGateway,
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
		},
		...
		},
		{
			...
			Value:   &c.AI.GatewayConfig.LegacyBedrock.BaseURL,
			Default: "",
			Group:   &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value:   &c.AI.GatewayConfig.LegacyBedrock.Region,
			Default: "",
			Group:   &deploymentGroupAIGateway,
			YAML:    "bedrock_region",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyBedrock.AccessKey,
			Default:     "",
			Group:       &deploymentGroupAIGateway,
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyBedrock.AccessKeySecret,
			Default:     "",
			Group:       &deploymentGroupAIGateway,
			Annotations: serpent.Annotations{}.Mark(annotationSecretKey, "true"),
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyBedrock.Model,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.LegacyBedrock.SmallFastModel,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.InjectCoderMCPTools,
			Default:     "false",
			Group:       &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.Retention,
			Default:     "60d",
			Group:       &deploymentGroupAIGateway,
			YAML:        "retention",
			Annotations: serpent.Annotations{}.Mark(annotationFormatDuration, "true"),
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.MaxConcurrency,
			Default:     "0",
			Group:       &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.RateLimit,
			Default:     "0",
			Group:       &deploymentGroupAIGateway,
			YAML:        "rate_limit",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.StructuredLogging,
			Default:     "false",
			Group:       &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value:   &c.AI.GatewayConfig.SendActorHeaders,
			Default: "false",
			Group:   &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.AllowBYOK,
			Default:     "true",
			Group:       &deploymentGroupAIGateway,
			YAML:        "allow_byok",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.CircuitBreakerEnabled,
			Default:     "false",
			Group:       &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value: serpent.Validate(&c.AI.GatewayConfig.CircuitBreakerFailureThreshold, func(value *serpent.Int64) error {
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.CircuitBreakerInterval,
			Default:     "10s",
			Hidden:      true,
			Group:       &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value:       &c.AI.GatewayConfig.CircuitBreakerTimeout,
			Default:     "30s",
			Hidden:      true,
			Group:       &deploymentGroupAIGateway,
		...
		},
		{
			...
			Value: serpent.Validate(&c.AI.GatewayConfig.CircuitBreakerMaxRequests, func(value *serpent.Int64) error {
				if value.Value() <= 0 || value.Value() > 100 {
					return xerrors.New("must be between 1 and 100")
				}
				return nil
...

		{
			...
			Value:       serpent.EnumOf(&c.AI.GatewayConfig.BudgetPolicy, AIBudgetPolicies...),
		...
		},
		{
			...
			Value:       serpent.EnumOf(&c.AI.GatewayConfig.BudgetPeriod, AIBudgetPeriods...),
		...
		// AI Bridge Proxy Options
		{
			...
			Value:       &c.AI.GatewayProxyConfig.Enabled,
			Default:     "false",
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.ListenAddr,
			Default:     ":8888",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "listen_addr",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.TLSCertFile,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "tls_cert_file",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.TLSKeyFile,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "tls_key_file",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.MITMCertFile,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "cert_file",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.MITMKeyFile,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "key_file",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.DomainAllowlist,
			Default:     "",
			Hidden:      true,
			Group:       &deploymentGroupAIGatewayProxy,
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.UpstreamProxy,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "upstream_proxy",
		},
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.UpstreamProxyCA,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.AllowedPrivateCIDRs,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
		...
		},
		{
			...
			Value:       &c.AI.GatewayProxyConfig.APIDumpDir,
			Default:     "",
			Group:       &deploymentGroupAIGatewayProxy,
			YAML:        "api_dump_dir",
		},
...
type AIConfig struct {
	GatewayConfig      AIGatewayConfig      `json:"bridge,omitempty"`
	GatewayProxyConfig AIGatewayProxyConfig `json:"aibridge_proxy,omitempty"`

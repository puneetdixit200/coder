...
// the recommended pattern: if the outer transaction rolls back, the
// caller calls PublishBuffer.Discard and Flush, and nothing reaches
...
// generation_attempt, status, archived, and optional worker_id /
// runner_id.
